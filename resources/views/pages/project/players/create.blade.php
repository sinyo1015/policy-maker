            ...
            <div class="py-1">
                ...
                <template x-if="is_success">
                    <div class="alert alert-success">
                        Berhasil menambahkan pihak, anda sedang diarahkan ke daftar pihak
                    </div>
                </template>
            </div>
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select x-model="selected_sector" name="" id="" class="form-control">
                            ...
                            <template x-for="(_sector, i) of sectors">
                                <option :value="_sector.id" x-text="_sector.name"></option>
                            </template>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select x-model="selected_level" name="" id="" class="form-control">
                            ...
                            <template x-for="(_level, i) of levels">
                                <option :value="_level.id" x-text="_level.name"></option>
                            </template>
                        </select>
                    </div>
                </div>
