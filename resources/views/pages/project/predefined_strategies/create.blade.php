                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select x-ref="select" name="" id="selectPlayer" class="form-control">
                            <option selected disabled>--Pilih Pihak--</option>
                        ...
                        <div style="height: 300px; overflow-y: scroll;">
                            <ul style="list-style: none">
                                ...
                                <template x-for="(_strategy, i) of strategies">
                                    <li>
                                        <input type="radio" :value="_strategy.id" x-model="selected_strategy" name="selected_strategy" id=""> <span x-text="_strategy.text"></span>
                                    </li>
                                </template>
    ...
    function __initAlpine() {
        return {
            ...
            async sendData() {
                ...
                this.errors = [];
                try {
                    let response = await axios.post("{{route('project_predefined_strategy.create_action', $id)}}", {
                        "_token": "{{csrf_token()}}",
