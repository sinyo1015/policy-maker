...
class PolicyInterestRepository implements PolicyInterestRepositoryInterface
{
    private PolicyInterest $model;

    public function __construct(PolicyInterest $model)
    {
        $this->model = $model;
    }
