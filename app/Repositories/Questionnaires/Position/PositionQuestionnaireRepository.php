...
namespace App\Repositories\Questionnaires\Position;

use App\Models\PositionQuestionnaire;

class PositionQuestionnaireRepository implements PositionQuestionnaireRepositoryInterface
{
    private PositionQuestionnaire $model;

    public function __construct(PositionQuestionnaire $model)
    {
        $this->model = $model;
    }
