...
use App\Models\PowerQuestionnaire;

class PowerQuestionnaireRepository implements PowerQuestionnaireRepositoryInterface
{
    private PowerQuestionnaire $model;

    public function __construct(PowerQuestionnaire $model)
    {
        $this->model = $model;
    }
