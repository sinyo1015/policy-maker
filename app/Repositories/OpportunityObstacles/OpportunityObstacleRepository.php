...
class OpportunityObstacleRepository implements OpportunityObstacleRepositoryInterface
{
    private OpportunityObstacle $model;

    public function __construct(OpportunityObstacle $model)
    {
        $this->model = $model;
    }
