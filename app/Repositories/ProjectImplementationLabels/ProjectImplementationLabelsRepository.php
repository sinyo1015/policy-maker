...
use App\Models\ProjectImplPeriodLabels;
use App\Repositories\ProjectImplementationLabels\ProjectImplementationLabelsInterface;

class ProjectImplementationLabelsRepository implements ProjectImplementationLabelsInterface
{

    private ProjectImplPeriodLabels $model;

    public function __construct(ProjectImplPeriodLabels $model)
    {
        $this->model = $model;
    }
