...
namespace App\Repositories\SuggestedStrategies;

use App\Models\SuggestedStrategy;

class SuggestedStrategyRepository implements SuggestedStrategyRepositoryInterface
{
    private SuggestedStrategy $model;

    public function __construct(SuggestedStrategy $model)
    {
        $this->model = $model;
    }
