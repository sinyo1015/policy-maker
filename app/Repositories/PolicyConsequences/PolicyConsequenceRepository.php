...
namespace App\Repositories\PolicyConsequences;

use App\Models\PolicyConsequence;

class PolicyConsequenceRepository implements PolicyConsequenceRepositoryInterface
{
    private PolicyConsequence $model;

    public function __construct(PolicyConsequence $model)
    {
        $this->model = $model;
    }
